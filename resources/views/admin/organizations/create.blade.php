                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name="name" 
                                       ...
                                       placeholder="Contoh: PR Desa Limbangan Timur" value="{{ old('name') }}" required>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="address" rows="5" 
                                          ...
                                          placeholder="Alamat sekretariat atau lokasi...">{{ old('address') }}</textarea>
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="type" class="w-full border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:ring-[#83218F] focus:border-[#83218F]">
                                    <option value="PR" {{ old('type') == 'PR' ? 'selected' : '' }}>PR (Ranting / Desa)</option>
                                    <option value="PK" {{ old('type') == 'PK' ? 'selected' : '' }}>PK (Komisariat / Sekolah)</option>
                                    <option value="PAC" {{ old('type') == 'PAC' ? 'selected' : '' }}>PAC (Kecamatan)</option>
                                </select>
                            </div>
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            <div class="relative w-full aspect-square bg-gray-50 rounded-xl overflow-hidden border-2 border-dashed border-gray-300 hover:border-[#83218F] transition group cursor-pointer">
                                ...
                                <div class="absolute inset-0 flex flex-col items-center justify-center text-gray-400 group-hover:text-[#83218F]" id="thumbPlaceholder">
                                    ...
                                    <span class="text-[10px] font-bold">Klik untuk Upload Logo</span>
                                </div>
