    ...
    <div class="min-h-screen bg-gray-50 font-sans pb-12">
        ...
        <div class="px-4 mt-6 max-w-xl mx-auto space-y-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <button onclick="alert('Sertifikat belum diterbitkan')" id="tour-cert" class="bg-white p-5 rounded-3xl shadow-sm border border-gray-100 flex flex-col items-center justify-center hover:shadow-md transition group opacity-50">
